...
class Calibrate:
    ...
    def __init__(self,instance,parent_dir=None):
        self.bounding_box = []
        self.currentframe = 0
    ...
    def calibrate(self,net,ln,input_conf,input_thres,dim,ds,ha,frame):
        ...
        if len(self.bounding_box) > 100:
            ...
            cam_par_dir = os.path.join(self.parent_dir,'models',"cam_parameters_{}.txt".format(str(self.instance)))
            # print('############################################')
            # print(cam_par_dir)
            # print('############################################')
            file1 = open(cam_par_dir,"w") 
